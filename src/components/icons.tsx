...
const base = (p: P, extra?: React.SVGProps<SVGSVGElement>) => ({
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
  strokeWidth: 1.7,
...
export const IconStar = ({ className = "w-3.5 h-3.5", filled = true }: P & { filled?: boolean }) => (
  <svg
    viewBox="0 0 24 24"
    className={className}
...
export const IconPalette = (p: P) => (
  <svg {...base(p)}>
    <path d="M12 22a10 10 0 1 1 10-10c0 2.21-1.79 4-4 4h-1.5a2.5 2.5 0 0 0-2.5 2.5c0 .61.22 1.17.6 1.6.38.44.6 1 .6 1.6A2.3 2.3 0 0 1 12 22Z" />
...
export const IconWhatsApp = ({ className = "w-4 h-4" }: P) => (
